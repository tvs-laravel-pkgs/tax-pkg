app.component('taxCodeList', {
    ...
    controller: function(HelperService, $rootScope, $scope, $window, $http, $route, $location) {
        var self = this;
        ...
        $http.get(
            ...
            var tax_code_list_dt_config = JSON.parse(JSON.stringify(dt_config));
            $('#tax_code').DataTable(
                $.extend(tax_code_list_dt_config, {
                    stateSave: true,
                    columns: column,
                    ordering: false,
                    processing: true,
