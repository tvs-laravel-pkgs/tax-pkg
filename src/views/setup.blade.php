...
<script type="text/javascript" src="{{URL::asset($tax_pkg_prefix . '/public/themes/'.$theme.'/tax-pkg/pages/tax/controller.js?v=2')}}"></script>
 <!-- ------------------------------------------------------------------------------------------ -->
 <!-- ------------------------------------------------------------------------------------------ -->
...
<script type="text/javascript" src="{{URL::asset($tax_pkg_prefix . '/public/themes/'.$theme.'/tax-pkg/pages/tax-code/controller.js?v=2')}}"></script>
